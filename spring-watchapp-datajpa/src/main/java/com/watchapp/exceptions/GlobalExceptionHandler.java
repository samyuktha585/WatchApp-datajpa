package com.watchapp.exceptions;
...
import com.watchapp.model.ApiErrors;
...
@ControllerAdvice
	public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
		...
		protected ResponseEntity<Object> handleWatchNotFound(WatchNotFoundException ex) {
			String message = ex.getMessage();
			LocalDateTime timestamp = LocalDateTime.now();
			String error = "watch not available";
		...
		protected ResponseEntity<Object> handleDescriptionNotFound(DescriptionNotFoundException ex) {
			String message = ex.getMessage();
			LocalDateTime timestamp = LocalDateTime.now();
